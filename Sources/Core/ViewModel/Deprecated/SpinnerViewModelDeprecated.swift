//
//  SpinnerViewModelDeprecated.swift
...
/// `SpinnerViewModelDeprecated` is the view model for both the SwiftUI `SpinnerView` as well as the UIKit `SpinnerUIView`.
...
final class SpinnerViewModelDeprecated: ObservableObject {
    enum Constants {
        enum Size {
    ...
    private let useCase: any SpinnerGetIntentColorUseCasable
    ...
    /// - userCase: `SpinnerGetIntentColorUseCasable` has a default value `SpinnerGetIntentColorUseCaseDeprecated`
    init(theme: any Theme,
         intent: SpinnerIntent,
         spinnerSize: SpinnerSize,
         useCase: any SpinnerGetIntentColorUseCasable = SpinnerGetIntentColorUseCaseDeprecated()) {
        self.theme = theme
        self.intent = intent
...
private extension SpinnerSize {
    var numeric: CGFloat {
        switch self {
        case .small: return SpinnerViewModelDeprecated.Constants.Size.small
        case .medium: return SpinnerViewModelDeprecated.Constants.Size.medium
        }
    }
}
